...
import "../src/FinanceSystem.sol"; // Adjust path as necessary
import "forge-std/console.sol";

contract GasDeploy is Script {
    function run() external returns (FinanceSystem) {
        address owner = address(0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266);
        vm.startBroadcast(0xac0974bec39a17e36ba4a6b4d238ff944bacb478cbed5efcae784d7bf4f2ff80);
        FinanceSystem fs = new FinanceSystem("MyOrg", owner);
        ...
        // Measure gas usage manually
        uint256 gasBefore = gasleft();
        fs.addTransaction(1000, "Subscription Service Payment", 0xfEdcBA9876543210FedCBa9876543210fEdCBa98, accounts[0], false, 1704067200);
        uint256 gasAfter = gasleft();

        uint256 gasUsed = gasBefore - gasAfter;
        console.log("Gas used for addTransaction:", gasUsed);
...
// Gas : 142,189 
// Eg : on low cost chain like arbitrum
// 142,189 gas × 0.01 Gwei = 1,421.89 Gwei
// 1,421.89 Gwei × 0.000000001 ETH/Gwei = 0.00000142189 ETH
// 0.00000142189 ETH × $3,661/ETH ≈ $0.0052
// If a db costs even $20 per month (mongo requires around $57 per month for one of their tiers)
// 20/0.0052 = 3,846 transactions per month
